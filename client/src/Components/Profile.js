  ...
  return (
    ...
    <div className="card_profile p-3 py-4">
      <div className="text-center"> 
        <img src={user?.image ? `uploads/${user?.image}`
         :"https://i.pinimg.com/736x/c9/e3/e8/c9e3e810a8066b885ca4e882460785fa.jpg"
          } width={100} className="rounded-circle" />
        ...
        <div className="social-buttons mt-5"> 
          <button className="neo-button"><FaFacebookF/></button> 
          <button className="neo-button"><FaFacebookMessenger/></button> 
          <button className="neo-button"> <FaRegEnvelopeOpen/></button> 
          <button className="neo-button"><FaInstagram/></button>
          <button className="neo-button"><FaTwitter/></button>
        </div>
        <div className="profile mt-5">
          <button className="profile_button px-5"  onClick={()=>inputRef.current.click()}>upload image</button>
